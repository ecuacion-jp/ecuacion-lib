 ...
 *     annotated points to an existing regular file.
 *
 * <p>It's invalid when the path points to a directory, or to nothing.</p>
 *
...
public @interface FileExists {
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.FileExists.message}";
