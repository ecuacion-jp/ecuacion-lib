...
import jp.ecuacion.lib.validation.constraints.TrueWhen.TrueWhenList;
import jp.ecuacion.lib.validation.constraints.enums.ConditionOperator;
import jp.ecuacion.lib.validation.constraints.enums.ConditionValue;

/**
 * Checks if specified {@code propertyPath} is {@code true} only when condition is satisfied.
 */
@PlacedAtClass
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(TrueWhenList.class)
@Documented
@Constraint(validatedBy = {TrueWhenValidator.class})
public @interface TrueWhen {
   ...
   * @return boolean
   */
  boolean falseWhenConditionNotSatisfied() default false;
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.TrueWhen.message}";
  ...
  /**
   * Defines several {@link TrueWhen} annotations on the same element.
   */
  @Target({ElementType.TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
  public @interface TrueWhenList {

    /**
     * Returns an array of TrueWhen.
     *
     * @return an array of TrueWhen
     */
    TrueWhen[] value();
  }
}
