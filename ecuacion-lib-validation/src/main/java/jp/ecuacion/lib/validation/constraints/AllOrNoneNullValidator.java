...
/**
 * Provides the validation logic for {@code AllOrNoneNull}.
 */
public class AllOrNoneNullValidator extends AllAnyValidator<AllOrNoneNull, Object> {
   ...
   */
  @Override
  public void initialize(@Nullable AllOrNoneNull annotation) {
