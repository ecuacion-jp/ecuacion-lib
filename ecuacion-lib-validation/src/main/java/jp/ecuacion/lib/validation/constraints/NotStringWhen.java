...
import jp.ecuacion.lib.validation.constraints.NotStringWhen.NotStringWhenList;
import jp.ecuacion.lib.validation.constraints.enums.ConditionOperator;
import jp.ecuacion.lib.validation.constraints.enums.ConditionValue;

/**
 * Checks if specified {@code propertyPath} does not match any of the specified strings
 *     only when condition is satisfied.
 */
@PlacedAtClass
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(NotStringWhenList.class)
@Documented
@Constraint(validatedBy = {NotStringWhenValidator.class})
public @interface NotStringWhen {
  ...
  /**
   * Specifies the string value(s) that {@code propertyPath} must not match.
   *
   * <p>The validation passes when the value of {@code propertyPath} does not equal
   *     any of the values specified here.</p>
   *
   ...
   * @return boolean
   */
  boolean stringWhenConditionNotSatisfied() default false;
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.NotStringWhen.message}";
  ...
  /**
   * Defines several {@link NotStringWhen} annotations on the same element.
   */
  @Target({ElementType.TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
  public @interface NotStringWhenList {

    /**
     * Returns an array of NotStringWhen.
     *
     * @return an array of NotStringWhen
     */
    NotStringWhen[] value();
  }
}
