...
@Repeatable(NotPatternWhenList.class)
@Documented
@Constraint(validatedBy = {NotPatternWhenValidator.class})
public @interface NotPatternWhen {
  ...
  /**
   * Specifies the regular expression that {@code propertyPath} must not match.
   *
   ...
   * @return boolean
   */
  boolean patternWhenConditionNotSatisfied() default false;
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.NotPatternWhen.message}";
  ...
  /**
   * Defines several {@link NotPatternWhen} annotations on the same element.
   */
  @Target({ElementType.TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
  public @interface NotPatternWhenList {

    /**
     * Returns an array of NotPatternWhen.
     *
     * @return an array of NotPatternWhen
     */
    NotPatternWhen[] value();
  }
}
