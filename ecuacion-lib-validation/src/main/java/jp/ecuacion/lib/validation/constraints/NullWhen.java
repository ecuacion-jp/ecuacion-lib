...
import jp.ecuacion.lib.validation.constraints.NullWhen.NullWhenList;
import jp.ecuacion.lib.validation.constraints.enums.ConditionOperator;
import jp.ecuacion.lib.validation.constraints.enums.ConditionValue;

/**
 * Checks if specified {@code propertyPath} is null only when condition is satisfied.
 */
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(NullWhenList.class)
@Documented
@Constraint(validatedBy = {NullWhenValidator.class})
public @interface NullWhen {
   ...
   * @return boolean
   */
  boolean notNullWhenConditionNotSatisfied() default false;
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.NullWhen.message}";
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
  public @interface NullWhenList {

    /**
     * Returns an array of NullWhen.
     *
     * @return an array of NullWhen
     */
    NullWhen[] value();
  }
}
