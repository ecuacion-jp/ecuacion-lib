...
import jp.ecuacion.lib.validation.constraints.PatternWhen.PatternWhenList;
import jp.ecuacion.lib.validation.constraints.enums.ConditionOperator;
import jp.ecuacion.lib.validation.constraints.enums.ConditionValue;

/**
 * Checks if specified {@code propertyPath} matches the specified regular expression
 *     only when condition is satisfied.
 */
@PlacedAtClass
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(PatternWhenList.class)
@Documented
@Constraint(validatedBy = {PatternWhenValidator.class})
public @interface PatternWhen {
  ...
  /**
   * Specifies the regular expression that {@code propertyPath} must match.
   *
   ...
   * @return boolean
   */
  boolean notPatternWhenConditionNotSatisfied() default false;
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.PatternWhen.message}";
  ...
  /**
   * Defines several {@link PatternWhen} annotations on the same element.
   */
  @Target({ElementType.TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
  public @interface PatternWhenList {

    /**
     * Returns an array of PatternWhen.
     *
     * @return an array of PatternWhen
     */
    PatternWhen[] value();
  }
}
