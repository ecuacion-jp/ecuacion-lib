...
import jp.ecuacion.lib.validation.constraints.ValueOfPropertyPathWhen.ValueOfPropertyPathWhenList;
import jp.ecuacion.lib.validation.constraints.enums.ConditionOperator;
import jp.ecuacion.lib.validation.constraints.enums.ConditionValue;

/**
 * Checks if the value of specified {@code propertyPath} equals the value of
 *     {@code propertyValuePropertyPath} only when condition is satisfied.
 */
@PlacedAtClass
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(ValueOfPropertyPathWhenList.class)
@Documented
@Constraint(validatedBy = {ValueOfPropertyPathWhenValidator.class})
public @interface ValueOfPropertyPathWhen {
  ...
  /**
   * Specifies the property path whose value {@code propertyPath} must equal.
   *
   * <p>The datatype of {@code propertyValuePropertyPath} can be the same as
   ...
   * @return boolean
   */
  boolean notValueOfPropertyPathWhenConditionNotSatisfied() default false;
  ...
  String message() default
      "{jp.ecuacion.lib.validation.constraints.ValueOfPropertyPathWhen.message}";
  ...
  /**
   * Defines several {@link ValueOfPropertyPathWhen} annotations on the same element.
   */
  @Target({ElementType.TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
  public @interface ValueOfPropertyPathWhenList {

    /**
     * Returns an array of ValueOfPropertyPathWhen.
     *
     * @return an array of ValueOfPropertyPathWhen
     */
    ValueOfPropertyPathWhen[] value();
  }
}
