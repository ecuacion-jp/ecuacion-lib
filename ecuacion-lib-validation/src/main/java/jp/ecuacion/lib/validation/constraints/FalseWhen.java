...
import jp.ecuacion.lib.validation.constraints.FalseWhen.FalseWhenList;
import jp.ecuacion.lib.validation.constraints.enums.ConditionOperator;
import jp.ecuacion.lib.validation.constraints.enums.ConditionValue;

/**
 * Checks if specified {@code propertyPath} is {@code false} only when condition is satisfied.
 */
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(FalseWhenList.class)
@Documented
@Constraint(validatedBy = {FalseWhenValidator.class})
public @interface FalseWhen {
   ...
   * @return boolean
   */
  boolean trueWhenConditionNotSatisfied() default false;
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.FalseWhen.message}";
  ...
  /**
   * Defines several {@link FalseWhen} annotations on the same element.
   */
  @Target({ElementType.TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
  public @interface FalseWhenList {

    /**
     * Returns an array of FalseWhen.
     *
     * @return an array of FalseWhen
     */
    FalseWhen[] value();
  }
}
