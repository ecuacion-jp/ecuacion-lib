...
import jp.ecuacion.lib.validation.constraints.NotNullWhen.NotNullWhenList;
import jp.ecuacion.lib.validation.constraints.enums.ConditionOperator;
import jp.ecuacion.lib.validation.constraints.enums.ConditionValue;

/**
 * Checks if specified {@code propertyPath} is not null only when condition is satisfied.
 */
@PlacedAtClass
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Repeatable(NotNullWhenList.class)
@Documented
...
public @interface NotNullWhen {
   ...
   * @return boolean
   */
  boolean nullWhenConditionNotSatisfied() default false;
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.NotNullWhen.message}";
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
  public @interface NotNullWhenList {

    /**
     * Returns an array of NotNullWhen.
     *
     * @return an array of NotNullWhen
     */
    NotNullWhen[] value();
  }
}
