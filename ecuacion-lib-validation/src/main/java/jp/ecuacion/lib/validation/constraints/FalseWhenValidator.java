...
/**
 * Provides the validation logic for {@code FalseWhen}.
 */
public class FalseWhenValidator extends ValidateWhenValidator<FalseWhen, Object> {

  /** Initializes an instance. */
  @Override
  public void initialize(@Nullable FalseWhen annotation) {
