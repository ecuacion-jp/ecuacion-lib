 ...
 *
 * <p>A string is valid if the value is blank or {@code Long.valueOf()} does not throw
 *     an exception.</p>
 *
 ...
 *     or not (=null).</p>
 */
public class LongStringValidator extends AbstractNumberStringValidator<LongString> {
