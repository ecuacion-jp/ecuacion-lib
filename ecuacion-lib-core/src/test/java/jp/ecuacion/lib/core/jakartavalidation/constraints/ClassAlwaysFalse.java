...
@Documented
@Constraint(validatedBy = {ClassAlwaysFalseValidator.class})
public @interface ClassAlwaysFalse {
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.lib.validation.constraints.ClassAlwaysFalse.message}";
