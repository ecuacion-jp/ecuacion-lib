...
public class Test91_12_util_PropertyFileUtilValueGetter extends TestTools {
  ...
  public void test21_hasProp_01_key_11_ファイルが存在しない場合() {
    PropertyFileUtilValueGetter store = new PropertyFileUtilValueGetter("non-exist-file");
  ...
  public void test31_複数locale_02_ファイル_locale_言語_01_client_locale_別言語() {
    try {
      PropertyFileUtilValueGetter store = new PropertyFileUtilValueGetter("test92-lang");
  ...
  public void test41_キー重複_01_同一ファイル内() {
    ...
    PropertyFileUtilValueGetter store = new PropertyFileUtilValueGetter("test92-duplicate-in-one-file");
    store.getProp("KEY2");
    assertTrue(true);
  }
  ...
  public void test41_キー重複_02_複数ファイル間() {
    try {
      PropertyFileUtilValueGetter store = new PropertyFileUtilValueGetter("test92-duplicate-in-multiple-files");
      store.getProp("KEY1");
      fail();
