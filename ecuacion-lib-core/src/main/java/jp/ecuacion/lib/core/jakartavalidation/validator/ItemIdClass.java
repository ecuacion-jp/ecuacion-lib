...
/**
 * Specifies {@code itemIdClass} on validated by {@code ValidationUtil}.
 * 
 * <p>When {@code ValidationUtil} validates some object, itemId is set by default.
...
@Retention(RUNTIME)
@Documented
public @interface ItemIdClass {

  /**
   * Specifies itemIdClass.
   */
  String value();
}
