...
import jp.ecuacion.lib.core.jakartavalidation.validator.GreaterThan.GreaterThanList;
 ...
 *     greater than the value of {@code basisPropertyPath}.
 * 
...
@Repeatable(GreaterThanList.class)
@Documented
...
public @interface GreaterThan {
   ...
   * Returns message ID.
   */
  String message() default "{jp.ecuacion.validation.constraints.GreaterThan.message}";
