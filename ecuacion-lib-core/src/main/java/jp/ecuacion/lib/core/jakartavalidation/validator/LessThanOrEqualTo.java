...
import jp.ecuacion.lib.core.jakartavalidation.validator.LessThanOrEqualTo.LessThanOrEqualToList;
...
public @interface LessThanOrEqualTo {
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.validation.constraints.LessThanOrEqualTo.message}";
