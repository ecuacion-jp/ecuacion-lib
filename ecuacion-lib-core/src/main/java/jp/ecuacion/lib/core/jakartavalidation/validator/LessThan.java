...
import jp.ecuacion.lib.core.jakartavalidation.validator.LessThan.LessThanList;
...
public @interface LessThan {
   ...
   * @return message ID
   */
  String message() default "{jp.ecuacion.validation.constraints.LessThan.message}";
